export const en = {
  ...
  venue: {
    ...
    directionsPhoto1Caption: "Leave the tarmac here, by the turismo rural and cocoon signs.",
    directionsPhoto2Caption: "Follow the sand road straight on, past the 50 sign.",
    directionsPhoto3Caption: "Keep going straight, vineyards on both sides.",
    directionsPhoto4Caption: "At the fork, take the narrow track to the left — not the wider road on the right.",
