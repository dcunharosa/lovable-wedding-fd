export const en = {
  ...
  venue: {
    ...
    directionsStep1:
      "Pin the turn-off marked above and follow the track north for about 1.6 km. The venue pin on its own can send you to the wrong side of the property, so use the turn-off first.",
    directionsStep2:
      "There may not be a sign at the turn-off. Once you are on the track, set Google Maps to Monte da Várzea — it routes correctly from there.",
    mapAria:
