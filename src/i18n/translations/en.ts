export const en = {
  ...
  venue: {
    ...
    directionsPhoto1Alt: "Fork in the sand track, with an arrow marking the left turn",
    directionsPhoto2Alt: "Sand track running straight between the vineyards",
    directionsPhoto3Alt: "Sand track continuing through the pine trees",
    directionsPhoto4Alt: "The turn-off from the paved road, beside the turismo rural sign",
  },
  travel: {
