...
export const pt: Translations = {
  ...
  venue: {
    ...
    directionsPhoto1Caption: "Saiam do alcatrão aqui, junto aos sinais de turismo rural e cocoon.",
    directionsPhoto2Caption: "Sigam em frente pela estrada de areia, depois do sinal dos 50.",
    directionsPhoto3Caption: "Continuem sempre em frente, com vinhas dos dois lados.",
    directionsPhoto4Caption: "Na bifurcação, sigam pelo caminho estreito à esquerda — não pela estrada mais larga à direita.",
  ...
  travel: {
    ...
    transfersMoreInfo: "Ver mais informação e reservar",
    transfersLessInfo: "Fechar",
