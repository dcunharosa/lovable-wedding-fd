  ...
  return (
    <PageLayout>
      ...
      <section className="py-20 px-4 text-center bg-accent">
        <p className="font-body text-sm tracking-[0.3em] uppercase text-accent-foreground/60 mb-6">
          Our Story
        </p>
        <p className="font-display text-2xl md:text-3xl text-accent-foreground/90 max-w-2xl mx-auto italic leading-relaxed">
