...
export const StaySection = () => {
  ...
  return (
    <section id="stay" className="min-h-[80vh] flex flex-col items-center justify-center px-4 py-12 text-center bg-[hsl(40_30%_95%)]">
      <p className="font-body text-base tracking-[0.3em] uppercase mb-3" style={{ color: "hsla(220, 50%, 55%, 0.6)" }}>Where We'll Be</p>
      <h1 className="font-display text-5xl md:text-7xl font-light mb-4" style={{ color: "hsl(220, 50%, 55%)" }}>Stay</h1>
      <p className="font-display text-xl italic max-w-lg mb-10" style={{ color: "hsla(220, 50%, 55%, 0.7)" }}>
