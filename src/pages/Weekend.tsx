  ...
  <section id="weekend" className="min-h-[80vh] flex flex-col items-center justify-center px-4 py-20 bg-[hsl(215_50%_82%)]" style={{ textShadow: "0 1px 6px rgba(0,0,0,0.15)" }}>
    ...
    <div className="max-w-4xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 animate-fade-in">
      ...
      <div className="border-l border-foreground/20 pl-8">
        <p className="font-body text-xs tracking-[0.2em] uppercase text-foreground/50 mb-1">Friday</p>
        <h3 className="font-display text-3xl text-foreground mb-2">Welcome Drinks</h3>
        <p className="font-body text-sm tracking-widest uppercase text-foreground/60 mb-4">From 6pm</p>
      ...
      <div className="border-l border-foreground/20 pl-8 space-y-10">
        <div>
          <p className="font-body text-xs tracking-[0.2em] uppercase text-foreground/50 mb-1">Saturday</p>
          <h3 className="font-display text-3xl text-foreground mb-6">The Wedding Day</h3>
        </div>

        <div>
          <h4 className="font-display text-xl text-foreground mb-1">Ceremony</h4>
          <p className="font-body text-sm tracking-widest uppercase text-foreground/60 mb-2">1pm</p>
          <p className="font-body text-sm text-foreground/70 leading-relaxed">
        ...
        <div>
          <h4 className="font-display text-xl text-foreground mb-1">Cocktail</h4>
          <p className="font-body text-sm tracking-widest uppercase text-foreground/60 mb-2">2pm</p>
          <p className="font-body text-sm text-foreground/70 leading-relaxed">
        ...
        <div>
          <h4 className="font-display text-xl text-foreground mb-1">Late Lunch & Party</h4>
          <p className="font-body text-sm tracking-widest uppercase text-foreground/60 mb-2">3:30pm</p>
          <p className="font-body text-sm text-foreground/70 leading-relaxed">
